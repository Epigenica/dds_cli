...
Welcome to the documentation of the |org| Data Delivery System's command line interface (``dds-cli``).
...
The Data Delivery System (DDS, |dds_url|) is a tool built for the simple and secure delivery
of data from |org| to their users. The system uses Safespring's object storage service as the delivery
...
* **How do I get an account?** You will need an invite from an existing user.
  ...
  * **I want data delivered to me from** |org|: Please contact |org| and ask for an invitation to the DDS.
  * **I'm delivering data to users**: Contact your colleagues and ask for an invitation, or reach out to |contact_email|.
   ...
   .. note::
      ...
      * If that doesn't help, contact |contact_email|.
...
* **Which account roles can I invite?**
  The `technical overview <https://dds.epigenica.se/technical>`_ has a detailed description of which actions each account role can perform.
